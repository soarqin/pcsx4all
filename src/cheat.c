...
static int cheat_run_code(const cheat_line_t *lines, int total, int *mcode_run)
{
  ...
  switch(code1 >> 24) {
    ...
    case 0x30:
      psxMemWrite8(code1 & 0x00FFFFFFu, code2 & 0xFFu);
      return 1;
    case 0x80:
      psxMemWrite16(code1 & 0x00FFFFFFu, code2);
      return 1;
    case 0x50:
    {
    ...
    case 0xE0:
      if (psxMemRead8(code1 & 0x00FFFFFFu) != (code2 & 0xFFu)) return -1;
      return 1;
    case 0xE1:
      if (psxMemRead8(code1 & 0x00FFFFFFu) == (code2 & 0xFFu)) return -1;
      return 1;
    ...
    case 0xE3:
      ...
      return 1;
    case 0xD0:
      if (psxMemRead16(code1 & 0x00FFFFFFu) != code2) return -1;
      return 1;
    case 0xD1:
      if (psxMemRead16(code1 & 0x00FFFFFFu) == code2) return -1;
      return 1;
    ...
    case 0xD3:
      ...
      return 1;
    case 0xC0:
      if (psxMemRead16(code1 & 0x00FFFFFFu) != code2) return -2;
      *mcode_run = 1;
      return 1;
    case 0xC1:
      if (code2 > 0)
      {
        *mcode_run = 1;
        next_ticks = get_curr_ticks() + code2;
        return -2;
      }
      return 1;
    case 0xD4:
